...
You can set the token in the headers instead of query, in **Authorization** like: `Bearer <WEBSOCKET_TOKEN>`. (if you set your token in headers and query, Sockety check both if it matches with a client).
